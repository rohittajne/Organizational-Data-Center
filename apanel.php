      ...
      <tr bgcolor="#FFFFFF">
        <td height="244"><table width="657" border="1" align="center">
		  ...
		  <tr>
            ...
            <td width="95"><span class="style5">Author</span></td>
            <td width="105"><span class="style5">File </span></td>
            <td width="94"><span class="style5">Description</span></td>
          </tr>
		            <?php
...
?>
          <tr>
            ...
            <td><span class="style8"><?php echo $row["Author"];?></span></td>
            <td><span class="style8"><?php echo $row["File"];?></span></td>
            <td><span class="style8"><?php echo $row["desc"];?></span></td>
          </tr>
  <?php
  }
  ?>
